...
Widget::Widget()
{
	...
	#if GTX__SAVE_SVG
	{
		PanelGen pg(assetPlugin(plugin, "build/res/Seq-G1R.svg"), box.size, "SEQ-G1R");
...

	{
		...
		panel->setBackground(SVG::load(assetPlugin(plugin, "res/Seq-G1R.svg")));
		addChild(panel);
	}
