...
void init(rack::Plugin *p) {
	...
	p->addModel(createModel<GTX::Seq_G1L::Widget>  ("Gratrix", "Seq-G1L",   "Seq-G1L",   SEQUENCER_TAG));
	p->addModel(createModel<GTX::Seq_G1R::Widget>  ("Gratrix", "Seq-G1R",   "Seq-G1R",   SEQUENCER_TAG));
