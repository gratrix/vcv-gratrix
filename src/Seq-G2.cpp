...
Widget::Widget()
{
	...
	addInput(createInputGTX<PortInMed>(Vec(gx(0), gy(2)), module, Impl::imap(Impl::GATE_INPUT, GTX__N)));
	addInput(createInputGTX<PortInMed>(Vec(gx(1), gy(2)), module, Impl::imap(Impl::VOCT_INPUT, GTX__N)));
}
